export default [
  {
    ...
    explanation: ` "돈 그거 얼마 되지도 않는 거 기부하면 도움이 되기나 해?"라는 사람들의 오랜 시간 자리 잡은 편견이 있다. 천원의 가치를 소중히 여기는 다이소의 기업 이념에 사랑의 열매 소액 기부를 콜라보하여 '소액 기부인식 개선 프로모션 영상'을 만들었다.
    치솟는 물가로 인해 더 이상 존재 가치가 무의미한 1000원은 주인공의 여정을 따라가며 그 가치를 찾게 되는 스토리이다.  소액 기부에 대한 긍정적 인식 개선을 기대하고, 선한 영향력을 끼치는 다이소의 이미지 상승과 사랑의 열매 기부 사용내역 투명성이 더욱 높아지는 효과를 기대한다.`,
    youtube: "https://www.youtube.com/embed/hBWsDb652bY?si=5haeFtix1lBI1D3M",
    still: [
  ...
  },
  {
    ...
    introduction: "세상에서 가장 쉬운 독서, 디지털 독서",
    explanation:
    ...
    youtube: "https://www.youtube.com/embed/GMvka7PAneY?si=m3FrAk7joRttRqfJ",
    still: [
  ...
  },
  {
    ...
    introduction: "결코 못나지 않습니다. 세상에 못난이는 없습니다.",
    explanation: `[못난 동그라미]는 최근 자기 비하를 일삼으며 우울해하는 청년 세대에게 위로의 메세지를 전달하고, 못난이 농산물에 대한 편견과 부정적인 이미지를 바꾸고자 제작한 '어글리어스' 마켓의 프로모션 영상이다.
    못난이 채소는 단지 못생긴 외형 때문에 판매되지 못하고 버려지는 채소들을 말한다. 이를 자기 비하를 하는 청년에게 비유하여 '세상에 못난이는 없으며, 못난 모습이 있더라도 그 자체로도 소중하고 가치가 있다'는 메세지를 전달하고자 하였다.
    ...
    youtube: "https://www.youtube.com/embed/Kl3oAweEuZw?si=EORLDPWSbRVVEeOd",
    still: [
  ...
  },
  {
    ...
    youtube: "https://www.youtube.com/embed/B1AwsVz9mLM?si=VBCNUwgIL2Fw4JiD",
    still: [
  ...
  },
  {
    ...
    introduction:
      "당신이 다시 내디딜 첫 걸음 부터, KT AI CARE 서비스가 함께 할게요",
    explanation:
    ...
    youtube: "https://www.youtube.com/embed/E2_J1t-90Qw?si=E6MM3Tc68szjOgGm",
    still: [
  ...
  },
  {
    ...
    introduction: "자전거는 탄소중립을 함께 하는 소중한 친구다",
    explanation:
    ...
    youtube: "https://www.youtube.com/embed/uym11tr1u_A?si=j41TVTZD5tUMZTVj",
    still: [
      "/image/workimage/promotion/todaycycle/still/1.jpg",
      "/image/workimage/promotion/todaycycle/still/2.jpg",
      "/image/workimage/promotion/todaycycle/still/3.jpg",
      "/image/workimage/promotion/todaycycle/still/4.jpg",
    ],
  },
];
