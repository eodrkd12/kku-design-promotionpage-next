...
export default function AboutScreen() {
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    ...
    // } else if (0.04 <= latest && latest < 0.06) {
    //   controls1.start({ opacity: 0 });
    //   controls2.start({ opacity: 0.2, y: 40 });
    ...
    <div className="parent-600vh" id="about">
      <ContentWrapper>
        <motion.div>
          ...
          <motion.h2 initial={{ opacity: 0, y: 100 }} animate={controls2} transition={{ duration: 0.5 }}>
            세상을 리드하는 멋진 Creator를 기대하며~
          </motion.h2>
          <motion.p initial={{ opacity: 0, y: 100 }} animate={controls2} transition={{ duration: 0.5 }}>
      ...
      <ContentWrapper>
        <div>
          <motion.h2 initial={{ opacity: 0, y: 100 }} animate={controls3} transition={{ duration: 0.5 }}>
            졸업을 진심으로 축하드립니다.
          </motion.h2>
          <motion.p initial={{ opacity: 0, y: 100 }} animate={controls3} transition={{ duration: 0.5 }}>
            졸업을 진심으로 축하합니다. 여러분에게 어떤 인사말이 도움이 될지
            곰곰이 생각해봤는데
            <br />
            '12가지 인생법칙'에서 조던 피터슨이 하셨던 말씀이 생각났습니다.
            <br />
            “지금 당신이 어디에 있는지 알아야 한다. 그래야 미래를 위한 계획을 세울 수 있다. 지금의 당신이
            <br />
      ...
      <ContentWrapper>
        <div>
          <motion.h2 initial={{ opacity: 0, y: 100 }} animate={controls4} transition={{ duration: 0.5 }}>
            졸업을 앞둔 여러분, 축하합니다!
          </motion.h2>
          <motion.p initial={{ opacity: 0, y: 100 }} animate={controls4} transition={{ duration: 0.5 }}>
      ...
      <ContentWrapper>
        <div>
          <motion.h2 initial={{ opacity: 0, y: 100 }} animate={controls5} transition={{ duration: 0.5 }}>
            자랑스러운 여러분의 졸업을 진심으로 축하합니다!
          </motion.h2>
          <motion.p initial={{ opacity: 0, y: 100 }} animate={controls5} transition={{ duration: 0.5 }}>
      ...
      <ContentWrapper>
        <div style={{
          ...
          <motion.h2 initial={{ opacity: 0, y: 100 }} animate={controls6} transition={{ duration: 0.5 }}>
            우선 졸업을 진심으로 축하합니다.
          </motion.h2>
          <motion.p initial={{ opacity: 0, y: 100 }} animate={controls6} transition={{ duration: 0.5 }}>
